...
const ServicesPage = () => {
  ...
  const content = {
    ar: {
      hero: {
        ...
        description: "نقدم منظومة خدمات متكاملة، صُممت لتعمل كوحدة واحدة متناغمة، تربط بين الاستراتيجية، التنفيذ، والتواصل"
      },
      services: [
        {
          id: 1,
          ...
          description: "نمتلك خبرة عملية في تنفيذ الفعاليات الكبرى ضمن منصات محلية ودولية وتحويلها إلى تجارب متكاملة تعكس الهوية وتحقق حضوراً مؤثراً.",
          items: [
        ...
        },
        {
          ...
          description: "نقدم حلول إنتاج إعلامي احترافية تغطي جميع مراحل العمل، من الفكرة إلى التنفيذ النهائي، وفق أعلى المعايير الفنية والإبداعية.",
          items: [
        ...
        },
        {
          ...
          description: "نستخدم التكنولوجيا والذكاء الاصطناعي كعناصر داعمة للاستراتيجية، بهدف تحسين الكفاءة وتعزيز تجربة المستخدم ودعم اتخاذ القرار.",
          items: [
        ...
        },
        {
          ...
          subtitle: "Branding",
          description: "نساعد المؤسسات على بناء علامات تجارية قوية، واضحة، وقابلة للنمو، من خلال حلول إبداعية مدروسة ترتكز على الفهم العميق للسوق والجمهور.",
          items: [
    ...
    en: {
      hero: {
        ...
        description: "We offer an integrated service ecosystem, designed to work as one harmonious unit, connecting strategy, execution, and communication"
      },
      services: [
        {
          id: 1,
          ...
          subtitle: "Core Capability",
          description: "We possess practical expertise in executing major events within local and international platforms, transforming them into integrated experiences that reflect identity and achieve impactful presence.",
          items: [
        ...
        },
        {
          ...
          subtitle: "Amplification & Supporting Layer",
          description: "We provide professional media production solutions covering all work stages, from concept to final execution, according to the highest technical and creative standards.",
          items: [
        ...
        },
        {
          ...
          subtitle: "Technology Enabling",
          description: "We use technology and AI as strategic support elements, aiming to improve efficiency, enhance user experience, and support decision-making.",
          items: [
        ...
        },
        {
          ...
          subtitle: "Branding",
          description: "We help organizations build strong, clear, and scalable brands through thoughtful creative solutions based on deep understanding of market and audience.",
          items: [
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      {/* Language Toggle */}
      ...
      <section className="relative">
        {t.services.map((service, index) => (
          ...
          >
            ...
            } from-red-600 to-transparent`}></div>
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-20">
              <div className={`grid md:grid-cols-2 gap-12 items-center ${
                ...
                {/* Icon Side */}
                <div className={`flex justify-center ${index % 2 === 0 ? 'md:justify-end' : 'md:justify-start md:order-2'}`}>
                  <div className="relative">
                    ...
                    <div className="relative w-48 h-48 md:w-64 md:h-64 flex items-center justify-center bg-gradient-to-br from-zinc-900 to-black border border-red-600/30 rounded-3xl">
                      <service.icon size={100} className="text-red-500" strokeWidth={1.5} />
                    </div>
                  </div>
                </div>
